...
const Offer = ({img,title,price,offText}) => {
  return (
    <div className="flex flex-col sm:flex-row sm:justify-start sm:items-start justify-center items-center gap-5 py-5 px-4 min-w-px bg-gray dark:bg-white2 dark:shadow-babyGray2 dark:shadow-lg rounded-[.3rem]" >
      <div className="w-43.75 h-43.75 border-5 rounded-full border-yellow overflow-hidden "data-aos="fade-right"  data-aos-duration="800" data-aos-delay="200">
        <img 
          src={img} 
          alt="Order" 
          loading="lazy" 
      ...
      <div className="flex flex-col items-center sm:items-start mt-0 sm:mt-4 gap-1 text-center sm:text-left" data-aos="fade-left"  data-aos-duration="800" data-aos-delay="400" >
        ...
        <div className="mt-2 float-animation "   data-aos="zoom-in"
         data-aos-delay="600"
